...
const projectId = "2JIwq3Gif3FHgmWapNKxiQ0ORza";
const projectSecret = "fdb606bdbbac08bc0ba4419598a2b7a9";
const auth =
...
export const VotingProvider = ({ children }) => {
  ...
  const uploadToIPFS = async (file) => {
    try {
      ...
      const url = `https://voting1212.infura-ipfs.io/ipfs/${added.path}`;
  ...
  const setCandidate = async (candidateForm, fileUrl, router) => {
    ...
    const ipfs = `https://voting1212.infura-ipfs.io/ipfs/${added.path}`;
